    ...
    return `
            <div class="collection" data-carousel="collection" data-id="${props.id}">
                ...
                <div class="movie-carousel">
                    <button class="arrow-slider arrow-slider__left" data-carousel="btn-previous"></button>
                    <button class="arrow-slider arrow-slider__right" data-carousel="btn-next"></button>
